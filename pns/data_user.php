...
<div class="pull-right">
    ...
    <tbody>
        <?php
            $sql_user = mysqli_query($connect, "SELECT a.id_user, a.username, a.password, a.hak_akses, a.nip, a.status, b.ruang_peg
            FROM tb_user a join tb_peg b on a.nip=b.nip") or die (mysqli_error($connet));
            $no=1;
