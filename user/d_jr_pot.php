...
<div class="container bootdey flex-grow-1 container-p-y">
            ...
            <div class="media align-items-center py-3 mb-3">
              ...
              <div class="media-body ml-4">
                ...
                ((gol+gr+MK+TJ+JAB+TF+LL)) as idks, (Pelayanan_pi+Farmasi_pi+Pelayanan_pl+Farmasi_pl+Hari_Raya+POT_BINA_SEHAT+ARISAN_KARU+POT_ARTHA_MEDIKA+Lain2) as pot FROM tb_jr a 
