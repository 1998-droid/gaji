  ...
  font-size: 1em;
            ...
            <div class="media align-items-center py-3 mb-3">
              ...
              <div class="media-body ml-4">
                <?php
                $sql_2 = mysqli_query($connect, "SELECT *, a.id_jam, a.nama, a.tgl, b.nip FROM tb_jam a 
            ...
            <div class="card md-0 card-responsive">
              ...
              <div class="table-responsive table-sm">
                <table class="table table-sm table-responsive card-table m-0" id="table_jp">
                  ...
                  <?php
                   $sql_2 = mysqli_query($connect, "SELECT *, a.id_jam, a.gol, a.Indeks_penyesuaian , a.id_jam, a.nama, a.tgl, b.nip, 
                   ...
                   ((Pelayanan_indeks+Farmasi_indeks+Pelayanan_langsung+Farmasi_langsung)-(Pelayanan_pi+Farmasi_pi+Pelayanan_pl+Farmasi_pl))
                    ...
                    ((Pelayanan_indeks+Farmasi_indeks+Pelayanan_langsung+Farmasi_langsung)-(Pelayanan_pi+Farmasi_pi+Pelayanan_pl+Farmasi_pl)-(Hari_Raya+Kurban+POT_BINA_SEHAT+RUANGAN+ARISAN_KARU+POT_ARTHA_MEDIKA+Lain2)) as neto FROM tb_jam a 
                   ...
                   if(mysqli_num_rows($sql_2)>0){
                    while ($data =mysqli_fetch_array($sql_2)){ ?>
                     <tr>
                       ...
                       <td><a href ="d_jam.php?id=<?=$data['id_jam']?>"
                       class= "btn btn-warning btn-sm"><i class="bi bi-archive"></i>detail</a>
                      </td>
                      <td><a href ="d_jam_pot.php?id=<?=$data['id_jam']?>"
