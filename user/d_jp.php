            ...
            <div class="media align-items-center py-3 mb-3">
              ...
              <div class="media-body ml-4">
                ...
                ((Pelayanan_indeks+Farmasi_indeks+Pelayanan_langsung+
					Farmasi_langsung)-(Pelayanan_pi+Farmasi_pi+Pelayanan_pl+Farmasi_pl)-(Hari_Raya+Kurban+POT_BINA_SEHAT+RUANGAN+ARISAN_KARU+POT_ARTHA_MEDIKA+Lain2)) as neto FROM tb_jp a 
                JOIN tb_user b ON a.nip=b.nip WHERE id_jp ='$id'") 
                ...
                <table class="table table-responsive table-borderless table-hover table-sm">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><a target="_blank" href="printjp.php?id=<?=$data['id_jp']?>" class="btn btn-primary btn-sm">Print</a></td>
                    </tr>
                  </tbody>
