...
<div class="col-lg-12">
    ...
    ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="pass" id="pass" value="<?=$data['password']?>" class="form-control" required >
                    </div>
                    <div class="form-group">
                        <label for="nip">Rekening</label>
                        <input type="number" name="nip" id="nip" value="<?=$data['nip']?>" class="form-control" required >
                    </div>
